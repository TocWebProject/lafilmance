...
import gsap from 'gsap';
    ...
    function animationTransition() {
      ...
      tlTransition.to(screen2.value, {
        ease: "Power1.easeInOut", x: "105%", duration: 2.5, delay: 1.3, zIndex: -10,
      });
...
<template>
    <div ref="introContainer" class="intro-container">
        <div ref="screen1" class="screen1">
            <video ref="videoPlayer" playsinline="true" disableremoteplayback width="320" height="240" poster="\videos\intro\capture-glitch-1-min.jpg" autoplay loop  muted>
                <source src="\videos\intro\VOLET-GLITCH-cote-droit.mp4"  type="video/mp4" />
            </video>
        </div>
        <div ref="screen2" class="screen2">
            <video ref="videoPlayer" playsinline="true" disableremoteplayback width="320" height="240" poster="\videos\intro\capture-glitch-2-min.jpg" autoplay loop  muted>
